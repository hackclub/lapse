...
export async function getAuthenticatedUser(req: FastifyRequest) {
...
export async function getRestAuthContext(req: FastifyRequest,): Promise<RestAuthContext> {
    const token = extractJWTFromRequest(req);
...
export function extractJWTFromRequest(req: FastifyRequest): string | null {
